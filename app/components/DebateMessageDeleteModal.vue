...
<template>
  <Teleport to="body">
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="debate-delete-modal-title"
    ...
    >
      <FwCard class="delete-modal__card" glass pad>
        ...
        <h2 id="debate-delete-modal-title" class="delete-modal__title">
          Nachricht löschen?
        </h2>
        <p class="delete-modal__lead delete-modal__lead--warn">
          Die Nachricht wird unwiderruflich entfernt. Antworten auf diese Nachricht
        ...
        <div class="delete-modal__actions">
          ...
          <FwButton variant="danger" type="button" :disabled="pending" @click="emit('confirm')">
